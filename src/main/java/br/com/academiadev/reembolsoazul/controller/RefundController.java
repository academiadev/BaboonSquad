...
public class RefundController extends UploadController {
	...
	@ApiResponses(value = { //
			@ApiResponse(code = 200, message = "Lista de reembolsos por usu�rios")
	})
	...
	@ApiOperation(value = "Listar reembolsos vis�veis para o usu�rio")
	@ApiResponses(value = { //
			@ApiResponse(code = 200, message = "Lista de reembolsos vis�veis para o usu�rios")
	})
	...
	@ApiImplicitParams({
		...
		@ApiResponses(value = { //
				@ApiResponse(code = 200, message = "Lista de gastos por usu�rios")
		})
